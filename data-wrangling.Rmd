...
```{r edit country names}
# countries
all_data %>% distinct(country_display_name_corrected) %>% arrange(country_display_name_corrected)

all_data <- all_data %>% 
  mutate(country_display_name_corrected =
    case_when(
      country_display_name_corrected == 
      ...
      country_display_name_corrected == 
        "Tanzania, United Republic of" ~ "Tanania",
      country_display_name_corrected ==
      ...
      TRUE ~ country_display_name_corrected)
  ) 
```
...
write_csv(all_data, "kickstarter_app/kickstarter_data.csv")
```
